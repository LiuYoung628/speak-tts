  ...
  return _createClass(SpeakTTS, [{
    ...
    value: function init() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var voice = (0, _utils.isNil)(conf.voice) ? undefined : conf.voice;
    ...
    value: function setVoice(voice) {
      ...
      if ((0, _utils.isString)(voice)) {
        synthesisVoice = voices.find(function (v) {
          return v.name === voice && v.lang === _this2.lang;
        });
      }
...
var _default = exports["default"] = SpeakTTS;